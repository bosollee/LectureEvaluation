...
public class EvaluationDAO {
	public int write(EvaluationDTO evaluationDTO) { // 로그인 함수
	...
	public int like(String evaluationID) {	//삭제
	...
	public int delete(String evaluationID) {	//추천
	...
	public String getuserID(String evaluationID) {	//추천
